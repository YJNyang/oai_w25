...
#define CMDLINE_NRUE_PHYPARAMS_DESC {  \
    ...
    {"config-freq-satellite",                NULL,         PARAMFLAG_BOOL,               iptr:&(UE->config_freq_satellite),         defintval:0,     TYPE_INT,    0},  \
    {"ffo-corr-shift",             NULL,                   0,               iptr:&(fp->ffo_corr_shift),            defintval:0,          TYPE_INT,   0}, \
    {"ifo-corr-shift",             NULL,                   0,               iptr:&(fp->ifo_corr_shift),            defintval:0,          TYPE_INT,   0}, \
